   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Please see the attached metadata document which will show which values are valid for each of the below input boxes.\n",
      "\n",
      "Section 1 - School Characteristics\n",
      "\n",
      "1. Does the school offer primary education?: \n",
      "No\n",
      "2. Does the school offer post-16 education?: \n",
      "Yes\n",
      "3. Is the school religious?: \n",
      "No\n",
      "4. What is the gender of the school? ('Mixed' or 'Single sex'): \n",
      "Mixed\n",
      "5. What is the school type? ('Academy', 'Academy Convertor', 'Community School' or 'Other'): \n",
      "Academy\n",
      "6. What is the admission policy of the school? ('Selective' or 'Non-Selective'): \n",
      "Non-selective\n",
      "7. What is the IDACI decile of the school?: \n",
      "3\n",
      "Section 2 - Historic Ofsted Information\n",
      "\n",
      "\n",
      "1. What was the previous Ofsted inspection score? ('Outstanding', 'Good', 'Requires Improvement' or 'Inadequate'): \n",
      "Good\n",
      "2. Was there a previous category of concern at the last inspection?: \n",
      "No\n",
      "3. How many days has it been since the previous Ofsted inspection?: \n",
      "951\n",
      "Section 3 - Pupil Characteristics and Attainment\n",
      "\n",
      "\n",
      "1. What is the average Key stage 2 Points Score of the cohort at the end of key stage 4?: \n",
      "9.7\n",
      "2. What percentage of pupils achieved Level 2 threshold including standard passes 9-4 in English and Maths GCSEs?: \n",
      "95\n",
      "3. What percentage of pupils achieved standard 9-4 passes in English and Maths GCSEs?: \n",
      "97\n",
      "4. What percentage of pupils achieved any qualifications?:\n",
      " 99\n",
      "5. What is the average number of GCSE and equivalents entries per pupil?:\n",
      " 9.8\n",
      "6. What is the overall absence as a percentage?:\n",
      " 6\n",
      "7. What percentage of pupils do not have English as their first language?: \n",
      "8\n",
      "8. What percentage of pupils are disadvantaged?: \n",
      "2\n",
      "Section 4 - Teacher Characteristics\n",
      "\n",
      "\n",
      "1. What is the mean gross salary of full-time teachers?: \n",
      "25000\n",
      "2. What is the pupil:teacher ratio?: \n",
      "9.4\n",
      "Computing...\n",
      "\n",
      "Based upon the model we predict the the school will receive an Outstanding inspection rating (this is 70% accurate).\n",
      "\n"
     ]
    }
   ],
